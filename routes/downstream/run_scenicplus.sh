...
# INPUT_RDS=output/RDS-files/my-variant-05-callpeaks-obj-list.RDS run/runmultiome run_scenicplus
...
Rscript scripts/downstream/export_scenicplus_data.R \
    "$INPUT_RDS"
...
python scripts/downstream/reformat_anndata.py data/scenicplus/$project_prefix.h5ad data/scenicplus/${project_prefix}_new.h5ad
...
python scripts/downstream/scenicplus_pipeline.py $config_file
