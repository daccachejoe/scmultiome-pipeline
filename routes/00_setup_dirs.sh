...
if [ ! -f configs/scenicplus-preprocess-config.yml ]; then
    cp scripts/downstream/scenicplus-config-template.yml configs/scenicplus-preprocess-config.yml
...
if [ ! -f configs/scenicplus-process-config.yml ]; then
    cp scripts/downstream/scenicplus-config-template.yml configs/scenicplus-process-config.yml
