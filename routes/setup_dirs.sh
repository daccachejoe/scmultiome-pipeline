...
cp configs/scenicplus-config.yaml configs/scenicplus-preprocess-config.yaml
cp configs/scenicplus-config.yaml configs/scenicplus-process-config.yaml
# change the process conig to set pycisTarget, scenicplus, and load_objects to true
sed -i 's/pycisTarget: false/pycisTarget: true/g' configs/scenicplus-process-config.yaml
sed -i 's/scenicplus: false/scenicplus: true/g' configs/scenicplus-process-config.yaml
sed -i 's/scenicplus_downstream: false/scenicplus_downstream: true/g' configs/scenicplus-process-config.yaml
sed -i 's/load_objects: false/load_objects: true/g' configs/scenicplus-process-config.yaml
