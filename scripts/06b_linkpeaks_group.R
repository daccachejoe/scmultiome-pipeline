#!/usr/bin/env Rscript
# Step 06b: run LinkPeaks on a single group's object (produced by
# scripts/06a_linkpeaks_split.R). Invoked once per group, in parallel,
# by routes/06_linkpeaks.sh.
#
