#!/usr/bin/env Rscript
# Step 06c: merge the per-group linked objects (produced by
# scripts/06b_linkpeaks_group.R) back into a single named list, once all
# group jobs have completed. Invoked by routes/06_linkpeaks.sh as a job
# dependent on every group job finishing.
#
